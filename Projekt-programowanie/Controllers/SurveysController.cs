...
namespace ProjektProgramowanie.Controllers
{
    public class SurveysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Survey survey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Survey survey)
        {
            if (id != survey.Id)
            {
                return NotFound();
