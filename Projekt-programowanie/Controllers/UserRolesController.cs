...
namespace ProjektProgramowanie.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Role,Description")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Role,Description")] UserRole userRole)
        {
            if (id != userRole.Id)
            {
                return NotFound();
